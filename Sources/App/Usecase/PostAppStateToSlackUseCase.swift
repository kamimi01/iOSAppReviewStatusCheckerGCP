...
class PostAppStateToSlackUseCase {
    ...
    init(appRepository: AppRepository = AppRepositoryImpl(), appStoreVersionRepository: AppStoreVersionRepository = AppStoreVersionRepositoryImpl(), slackRepository: SlackRepository = SlackRepository(), messageRepository: MessageRepository = MessageRepositoryImpl(), app: Application, req: Vapor.Request) {
